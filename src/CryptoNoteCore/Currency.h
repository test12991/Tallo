...
private:
  ...
  Difficulty nextDifficultyBuggedZawy(uint8_t version, uint32_t blockIndex, std::vector<uint64_t> timestamps, std::vector<Difficulty> cumulativeDifficulties) const;
